...
/* -----------------------------------------------------------------------------------------* 
   Inputs:
   1. sourceFile: Location where the folder will get saved.
   2. targetFolder: Name of folder to be created.

   Outputs:
   1. folderCreated: Indicator whether folder has been created.
   2. targetFolderURI: The folder URI of the target folder.
*------------------------------------------------------------------------------------------ */
...
%macro _cff_main_execution_code(sourceFile, targetFolder);
...
%if &_cff_run_trigger. = 1 %then %do;
   ...
   %_cff_main_execution_code(&sourceFile., &targetFolder.);
